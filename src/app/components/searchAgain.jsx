    ...
    return(
        <div className="grid grid-flow-col place-self-center place-content-center">
            <input value={searchW} onChange={change} className="rounded-md bg-amber-50 placeholder-stone-500 text-stone-950
               w-[600px] h-[40px] min-[290px]:h-[40px] px-4 min-[340px]:px-8 text-sm min-[340px]:text-lg" placeholder="Search for a product..."/>
            <button onClick={search} className="rounded-md theme1 Bigger BoxShine place-self-end absolute w-[40px] h-[40px] text-2xl ">S</button>
        </div>
    )
}

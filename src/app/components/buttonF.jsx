...
export default function ButtonF(props){
    ...
    const [visual, setVisual] = useState("theme1 TextShine2 Bigger text-xl"); //estado visual del boton]

    useEffect(() => {
        if(status === true){
            set(value);
            setVisual("theme2 px-2 py-1 rounded-md text-xl");
        }else{
            set("default");
            setVisual("theme1 TextShine2 Bigger text-xl");
        }
